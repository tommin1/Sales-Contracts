...
namespace Sales_Contracts.Data.Migrations
{
    ...
    [Migration("20180407220243_contractz")]
    partial class contractz
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NAVN.Contract", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("Agreement_Status_Code");

                    b.Property<bool?>("Agreement_Valid");

                    b.Property<bool?>("Auto_continuation");
                    ...
                    b.Property<bool?>("Open_ended_Contract");
                    ...
                    b.Property<string>("Primary_Contract_No");

                    b.Property<int?>("Primary_Contract_No_LinkID");

                    b.Property<string>("Responsible_Person_Code");

                    b.Property<DateTime?>("Starting_Date");

                    b.HasKey("ID");

                    b.HasIndex("Primary_Contract_No_LinkID");

                    b.ToTable("Contract");
                });

            modelBuilder.Entity("NAVN.ContractLines", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("Contract_No_LinkID");
                    ...
                    b.Property<decimal?>("RealizedQuantity");

                    b.Property<DateTime?>("Shipment_Due_Date");

                    b.Property<string>("ShortcutDimCode_x005B_3_x005D_");

                    b.Property<string>("ShortcutDimCode_x005B_4_x005D_");

                    b.Property<string>("ShortcutDimCode_x005B_5_x005D_");

                    b.Property<string>("ShortcutDimCode_x005B_6_x005D_");

                    b.Property<string>("ShortcutDimCode_x005B_7_x005D_");

                    b.Property<string>("ShortcutDimCode_x005B_8_x005D_");
                    ...
                    b.HasIndex("Contract_No_LinkID");

                    b.ToTable("ContractLines");
                });

            modelBuilder.Entity("NAVN.Contracts", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NAVN.Contract", b =>
                {
                    b.HasOne("NAVN.Contracts", "Primary_Contract_No_Link")
                        .WithMany()
                        .HasForeignKey("Primary_Contract_No_LinkID");
                });

            modelBuilder.Entity("NAVN.ContractLines", b =>
                {
                    b.HasOne("NAVN.Contract")
                        .WithMany("ContractLines")
                        .HasForeignKey("ContractID");

                    b.HasOne("NAVN.Contracts", "Contract_No_Link")
                        .WithMany()
                        .HasForeignKey("Contract_No_LinkID");
                });
